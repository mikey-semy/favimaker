...
Название рабочее: проект может вырасти за пределы иконок. Что и в каком порядке
— [docs/ROADMAP.md](docs/ROADMAP.md), план на год. Разбор состояния и
осуществимости — [docs/PLAN.md](docs/PLAN.md).
